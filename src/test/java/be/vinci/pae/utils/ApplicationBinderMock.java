...
public class ApplicationBinderMock extends AbstractBinder {
  ...
  protected void configure() {
    // to avoid error Cannot invoke "be.vinci.pae.domain.UserUcc.getOne(int)" because "this.userUcc" is null
    bind(UserUccImpl.class).to(UserUcc.class).in(Singleton.class);
    //to avoid calling the UserDataServiceImpl which call the database but cant ass dev.propreties not initialzied
