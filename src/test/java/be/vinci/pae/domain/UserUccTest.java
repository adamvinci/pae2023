...
class UserUccTest {
    ...
    void testLoginWithBadEmailAndGoodPassword() {
        Mockito.when(userDataService.getOne("stevenagbassah@student.vinci.be"))
                .thenReturn(null);
        assertNull(userUcc.login("stevenagbassah@student.vinci.be", "123*"), "Cette email n'existe pas");
    ...
    void testLoginWithBlankPassword() {
        assertNull(userUcc.login("steven.agbassah@student.vinci.be", " "), "Completer le champ password");
    }
